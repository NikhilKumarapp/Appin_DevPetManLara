                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.posts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="like_count" id="like_count" value="{{ old('like_count', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="unlike_count" id="unlike_count" value="{{ old('unlike_count', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="view_count" id="view_count" value="{{ old('view_count', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_report" id="is_report" value="1" {{ old('is_report', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="answer_count" id="answer_count" value="{{ old('answer_count', '0') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="option_1" id="option_1" value="{{ old('option_1', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="option_2" id="option_2" value="{{ old('option_2', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="option_3" id="option_3" value="{{ old('option_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="option_4" id="option_4" value="{{ old('option_4', '') }}">
