    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.update", [$post->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('like_count') ? 'is-invalid' : '' }}" type="number" name="like_count" id="like_count" value="{{ old('like_count', $post->like_count) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unlike_count') ? 'is-invalid' : '' }}" type="number" name="unlike_count" id="unlike_count" value="{{ old('unlike_count', $post->unlike_count) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('view_count') ? 'is-invalid' : '' }}" type="number" name="view_count" id="view_count" value="{{ old('view_count', $post->view_count) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_report') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_report" id="is_report" value="1" {{ $post->is_report || old('is_report', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('answer_count') ? 'is-invalid' : '' }}" type="number" name="answer_count" id="answer_count" value="{{ old('answer_count', $post->answer_count) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('option_1') ? 'is-invalid' : '' }}" type="text" name="option_1" id="option_1" value="{{ old('option_1', $post->option_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('option_2') ? 'is-invalid' : '' }}" type="text" name="option_2" id="option_2" value="{{ old('option_2', $post->option_2) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('option_3') ? 'is-invalid' : '' }}" type="text" name="option_3" id="option_3" value="{{ old('option_3', $post->option_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('option_4') ? 'is-invalid' : '' }}" type="text" name="option_4" id="option_4" value="{{ old('option_4', $post->option_4) }}">
