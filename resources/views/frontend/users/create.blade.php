                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="social_token" id="social_token" value="{{ old('social_token', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="social_platform" id="social_platform" value="{{ old('social_platform', '') }}">
