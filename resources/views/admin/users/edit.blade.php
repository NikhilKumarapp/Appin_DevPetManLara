    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_token') ? 'is-invalid' : '' }}" type="text" name="social_token" id="social_token" value="{{ old('social_token', $user->social_token) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_platform') ? 'is-invalid' : '' }}" type="text" name="social_platform" id="social_platform" value="{{ old('social_platform', $user->social_platform) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" name="age" id="age">{{ old('age', $user->age) }}</input>
                @if($errors->has('age'))
