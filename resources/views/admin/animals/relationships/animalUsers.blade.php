    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-animalUsers">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.user.fields.animal') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-animalUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
