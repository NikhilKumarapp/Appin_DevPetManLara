                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('follow_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.follows.index') }}">
                                            {{ trans('cruds.follow.title') }}
                                        </a>
                                    @endcan
                                    @can('pet_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.pets.index') }}">
                                    ...
                                    @endcan
                                    @can('breed_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.breeds.index') }}">
                                    ...
                                    @can('reports_abuse_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.reports-abuses.index') }}">
                                    ...
                                    @endcan
                                    @can('like_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.likes.index') }}">
                                            {{ trans('cruds.like.title') }}
                                        </a>
                                    @endcan
                                    @can('dislike_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.dislikes.index') }}">
                                            {{ trans('cruds.dislike.title') }}
                                        </a>
                                    @endcan
                                    @can('view_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.views.index') }}">
                                            {{ trans('cruds.view.title') }}
                                        </a>
                                    @endcan
                                    @can('user_address_access')
                                        <a class="dropdown-item" href="{{ route('frontend.user-addresses.index') }}">
